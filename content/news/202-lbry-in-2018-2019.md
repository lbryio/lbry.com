...
* We launched a [YouTube partnership program](https://lbry.io/youtube) that has brought in nearly 10,000 publishers, including 45 with 250,000+ subscribers.  There are too many standouts to list all of them, but a few are: [@MinutePhysics](https://open.lbry.io/@MinutePhysics), [@MothersBasement](https://open.lbry.io/@MothersBasement), and [@GaminGHD](https://open.lbry.io/@GaminGHD).
