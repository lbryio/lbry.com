...
8. Install the latest version of LBRY from the [Github App Page](https://github.com/lbryio/lbry-app/releases "Github App Page"). If prompted to allow through Windows Firewall, click Allow
...
8. Install the latest version of LBRY from the [Github App Page](https://github.com/lbryio/lbry-app/releases "Github App Page")
