...
<p>By clicking to agree to these Terms of Service (<strong>“Terms”</strong>) when running/installing our software, publishing content to LBRY, or by otherwise accessing or using the network [via proxy or direct], mobile applications and online services (collectively, our <strong>“Services”</strong>) of LBRY Inc. (<strong>“Company,” “we,” or “us”</strong>), you agree to be bound by these Terms. If you do not agree to these Terms, you may not access or use the Services for any purpose. Please refer to our Privacy Policy https://lbry.com/privacypolicy for information about how we collect, use and disclose information about you.</p>

<p>You and the Company agree as follows:</p>

<h3 id="toc_0">1. Overview of LBRY and the Services</h3>

<p><strong>“LBRY”</strong> is a decentralized, consensus-driven protocol that enables the publication and viewing of information, videos, music, data and other materials (<strong>“Content”</strong>).  Content is distributed to LBRY by publishers and is stored in fragmented shards via a distributed network of third-party devices (<strong>“Hosts”</strong>) that utilize LBRY.  LBRY also allows publishers to bid on and reserve names (<strong>“Names”</strong>), which can be used as a unique identifier for Content.  Please consult lbry.tech to learn more about the technical architecture of LBRY. </p>

<p>The Services provide an interface for you to interact with LBRY, including to publish, access, or host Content through LBRY. The LBRY protocol is not owned, operated, or maintained by us. We have no responsibility or liability for LBRY, and the Company has no ability to control third parties’ use of LBRY. We are not able to delete or remove Content that has been published through LBRY and that may be accessible via the Services. </p>
...
<li>contains sensitive personal information, including “protected health information,” as defined under HIPAA and its implementing rules; “cardholder data,” as defined by the PCI DSS; “personal information” of a “child” as such terms are defined under the Children’s Online Privacy Protection Act and its implementing rules; or personal data revealing racial or ethnic origin, political opinions, religious or philosophical beliefs, or trade union membership, and the processing of genetic data, biometric data for the purpose of uniquely identifying a natural person, data concerning health or data concerning a natural person&#39;s sex life or sexual orientation;</li>
<li>contains viruses, corrupted data or other harmful, disruptive or destructive files; UNLESS CLEARLY LABELED AS SUCH</li>
<li>in the sole judgment of the Company, is objectionable or which restricts or inhibits any other person from using or enjoying LBRY or the Services, or which may expose the Company or its users to any harm or liability of any type.</li>
<li>USD equivalent of LBRY Credits [LBC] is determined by 3rd party markets such as Bittrex and Poloniex, not LBRY INC.</li>
</ul>
...
<p>a) In using our Services, you may view or otherwise interact with Content provided by publishers. Your dealings or correspondence with any publisher of Content are solely between you and that publisher. The Company is not responsible or liable for any damage or loss of any sort caused, or alleged to be caused, by or in connection with any such dealings, including the delivery, quality, safety, legality or any other aspect of any Content that you may access using our Services.</p>

<p>b) In certain instances, your access to Content may be subject to sale terms set forth in the metadata of the Content. Company, in its sole discretion, may from time to time impose limits on the ability to purchase Content via the Services. Upon your access of any purchased Content, you and the publisher will enter into a separate agreement, pursuant to which you agree to pay the specified fees for the Content and the publisher agrees to make such Content available to you. THE COMPANY DOES NOT HAVE THE POWER OR RESPONSIBILITY TO PROVIDE ANY REFUNDS. You agree to look solely to the publisher to resolve any disputes regarding Content, and that publishers are solely responsible for providing any refunds.</p>

<p>c) All payments for content will be made using LBC and occur on the LBRY blockchain.  Purchaser is buying the right to access content for personal non-commercial use unless content creator provides a license for commercial use or remixing.</p>

<h3 id="toc_4">5. Hosting Content</h3>

<p>This section applies to you if you host any Content via LBRY using the Services. The Services allow Hosts to make available storage space (<strong>“Space”</strong>) on the Host’s device for the storage of Content published through LBRY
By making available Space on your device, you authorize any user of our Services to: (i) store Content published through LBRY onto your device; and (ii) access such Content from your device at any time. </p>

<p>a) You represent and warrant that (i) you own or control your device, and have the right to provide the Space on your device pursuant to these Terms; and (ii) you will not breach any agreement to which you are a party in connection with your performance under these Terms, including any agreement you have with a third-party Internet service provider. </p>

<p>b) By allowing Space to be utilized to store Content distributed through LBRY, you understand that your device may be impacted due to the additional constraints being placed on it by the processing of Content. In particular, your device may not operate as quickly as it would without making Space available for others to utilize. </p>

<p>c) You will not: (i) reverse engineer any aspect of the Content stored on your device or do anything that might discover the contents or origin of the Content; (ii) attempt to bypass or circumvent measures employed to prevent or limit access to the Content, including attempting to defeat any encryption; or (iii) attempt to interfere with the storage or transmission of Content.</p>

<h3 id="toc_5">6. General Conduct Restrictions</h3>

<p>You are solely responsible for your conduct while using the Services. You will comply with all applicable laws and third-party agreements to which you are bound. Further, you will not do any of the following in connection with the Services or any other users: </p>

<p>a) Use the Services in any manner that could interfere with, disrupt, negatively affect or inhibit other users from fully enjoying the Services or that could damage, disable, overburden or impair the functioning of the Services in any manner;</p>

<p>b) Impersonate or distribute Content on behalf or any person or entity or otherwise misrepresent your affiliation with a person or entity;</p>
...
<p>e) Send, distribute or post spam, unsolicited or bulk commercial electronic communications, chain letters, or pyramid schemes;</p>

<p>f) Harvest or otherwise collect information about users, including email addresses, without their consent;</p>

<p>g) Use the Services for any illegal or unauthorized purpose or engage in, encourage, or promote any illegal activity, or any activity that violates these Terms; </p>

<p>h) Use the Services to distribute Content that you do not have the lawful right to distribute or reproduce; or</p>

<p>i) Circumvent or attempt to circumvent any filtering, security measures or other features we may from time to time adopt to protect the Company, the Services, its users or third parties.</p>

<p>The Company does not endorse or adopt any Content and you acknowledge and agree that the Company will have no responsibility for any Content, including without limitation, material that may be misleading, incomplete, erroneous, offensive, indecent or otherwise objectionable. Enforcement of the Content rules set forth in these Terms is solely at our discretion, and subject to our technical capabilities. Failure to enforce such rules in some instances does not constitute a waiver of our right to enforce such rules in other instances. In addition, these rules do not create any private right of action on the part of any third party or any reasonable expectation that the Services will not link to any Content that is prohibited by such rules. </p>

<h3 id="toc_6">7. Limited License; Copyright and Trademark</h3>

<p>Our Services and the text, graphics, images, photographs, illustrations, trademarks, trade names, service marks, logos, slogans and other content contained therein (collectively, the <strong>“Company Marks”</strong>) are owned by Company and its licensors and are protected under both United States and foreign laws, and may not be copied, imitated or used, in whole or in part, without our or the applicable licensor’s prior written permission. You may not use any metatags or other “hidden text” utilizing any Company Marks without our prior written permission. Further, you may not use, frame or utilize framing techniques to enclose any Company Mark, the content of any text or the layout or design of any page or form contained on a page, on the Services without the Company’s express written consent.</p>

<h3 id="toc_7">8. Open Source Software</h3>

<p>a) We may, from time to time, release the source code for certain of the software that supports our Services. You agree to be bound by, and comply with, any license agreement that applies to this open source software. You will not indicate that you are associated with Company in connection with any of your modifications or distributions of this open source software. </p>
...
<p>Designated Agent: LBRY INC <br />
Address: 99 Hanover St, Manchester, NH 03101<br />
Telephone Number: 907-318-5956<br />
Fax Number: 801-327-6808</p>

<p>E-Mail Address: hello@lbry.com</p>
...
<p><strong>The total liability of the Company and the other Company Parties, for any claim arising out of or relating to these Terms or our Services, regardless of the form of the action, is limited to the greater of any amount paid, if any, by you to access or use our Services or $100 USD.</strong></p>
